...
def match(o, e):
    ...
    raise NotImplementedError("Don't know how to match {} to an error".format(o))
...
@match.method(type(None))
def _none(f, e):
    # if we're expecting "None" (no error) then any error is non-matching.
    return False
